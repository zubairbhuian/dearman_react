              ...
              <form action="#">
                ...
                <div className="uesr-item">
                  <div className="mb-3 side-by-side">
                    <label for="exampleFormControlInput1" className="form-label">DL number<span
                ...
                <div className="uesr-item">
                  <div className="mb-3 side-by-side">
                    <label for="exampleFormControlInput1" className="form-label">Expires<span
                        className="color-red">*</span></label>
                    <select className="form-select h4" aria-label="Default select example">
                      <option selected></option>
                      <option value="1">item 1</option>
                    ...
                    <div className="Neon Neon-theme-dragdropbox">
                      ...
                      <div className="Neon-input-dragDrop">
                        <div className="Neon-input-inner">
                          <Link className="Neon-input-choose-btn blue form-control">Front of driver's license</Link></div>
                      </div>
                    </div>
                  </div>
                  <div className="mb-3 side-by-side">
                    <div className="Neon Neon-theme-dragdropbox">
                      <input className='cus_file_one'
                         type="file"/>

                      <div className="Neon-input-dragDrop">
                        <div className="Neon-input-inner">
                          <Link className="Neon-input-choose-btn blue form-control">Back of driver's license</Link></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="uesr-item">
                  <div className="mb-3 side-by-side">
                    <label for="exampleFormControlInput1" className="form-label">TWIC number<span
                        className="color-red">*</span></label>
                    <input type="number" className="form-control" id="number" placeholder=""/>
                  </div>
                  <div className="mb-3 side-by-side">
                    <label for="exampleFormControlInput1" className="form-label">Expires</label>
                    <select className="form-select h4" aria-label="Default select example">
                      <option selected></option>
                      <option value="1">item 1</option>
                    </select>
                ...
                <div className="uesr-item">
                  <div className="mb-3 side-by-side">
                    <div className="Neon Neon-theme-dragdropbox">
                      ...
                      <div className="Neon-input-dragDrop">
                        <div className="Neon-input-inner">
                          <Link className="Neon-input-choose-btn blue form-control">Front of TWIC</Link></div>
                      </div>
                    </div>
                  </div>
                  <div className="mb-3 side-by-side">
                    <div className="Neon Neon-theme-dragdropbox">
                      ...
                      <div className="Neon-input-dragDrop">
                        <div className="Neon-input-inner">
                          <Link className="Neon-input-choose-btn blue form-control">Back of TWIC</Link></div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="offcanvas-destinations-cta">
          <ul className="nav nav-pills mt-5">
            <li className="nav-item">
              <Link data-bs-toggle="offcanvas" to="#" className="secound-btn mt-5 me-2 bg-tra"
            >
                Back
              </Link>
            </li>
          ...
          <Link to="destinations.html" className="secound-btn mt-5 me-2 bg-tra">Cancel</Link>
        </div>
      </div>
    </div>
