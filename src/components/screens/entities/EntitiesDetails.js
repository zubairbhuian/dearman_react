            ...
            <div class="text-content">
              <div class="d-flex justify-content-between">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center">
                  <Link to="#" class="btn connected-btn"><BsExclamationCircle className="me-2"/>Invitation not yet accepted</Link>
                  <Link to="" class="mt-2">Re-send invite</Link>
                </div>
              </div>
              <div class="del-sec-left">
                <button class="btn">
                  <BsX className="me-2"/>
                  Delete a Terminal</button>
              </div>
            </div>
          </div>
          {/* tab */}
